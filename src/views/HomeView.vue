    ...
    <div class="text-white text-left" v-else-if="animes && animes.length > 0 && !isLoading">
      <div class="relative h-[300px] overflow-clip">
        ...
        <div
          ...
          <p class="bg-white text-[3rem] rounded-lg px-4">{{ singleAnime.title }}</p>
          <div class="flex right-[0px] py-4 gap-[10px]">
        ...
        <button class="bg-orange p-2 rounded-lg z-[2] absolute bottom-[10px] left-[30px] flex items-center px-4">
      ...
      <div class="text-right pr-2">
        <v-icon name="bi-arrow-left-circle" scale="2.4" class="mr-4" @click="increasePageNo"></v-icon>
        <v-icon name="bi-arrow-right-circle" scale="2.4"></v-icon>
      </div>
    </div>
