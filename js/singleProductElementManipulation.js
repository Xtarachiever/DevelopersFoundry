          ...
          <div class=" w-full py-4 shadow-lg"><img src=${
            ...
            <div class="main_container flex flex-col md:flex-row justify-between gap-[20px] pb-4 sm:pb-0">
              <div class="details p-[20px] w-full md:w-[60%] lg:w-[70%]">
                ...
                <p class="product_description"><p class="font-semibold text-sm">Event description</p> ${
              ...
              <div class="contact_div w-full md:w-[40%] lg:w-[30%] md:pt-10 flex items-start flex-col p-[20px]">
                ...
                <div class="pt-6 w-full h-full max-h-[500px] text-left sm:min-h-[400px] md:min-h-[350px]">
                  <p>Directions</p>
                  <div class="relative w-full h-[80%] xl:h-full min-h-[300px]">
            ...
            <div class="navigation_button absolute gap-[40px] right-[40px] -bottom-[5px] xl:-bottom-[40px] flex gap-[20px]">
